...
entrySetMaxLength :: EntryClass self => self
 -> Word16 -- ^ @max@ - the maximum length of the entry, or 0 for no maximum.
...
entryGetMaxLength :: EntryClass self => self
 -> IO Word16 -- ^ returns the maximum allowed number of characters in 'Entry',
...
-- Default value: 0
--
entryCursorPosition :: EntryClass self => ReadAttr self Word16
entryCursorPosition = readAttrFromUInt16Property "cursor-position"
...
-- Default value: 0
--
entrySelectionBound :: EntryClass self => ReadAttr self Word16
entrySelectionBound = readAttrFromUInt16Property "selection-bound"
...
-- Default value: 0
--
entryMaxLength :: EntryClass self => Attr self Word16
