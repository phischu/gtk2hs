...
-- * Available since Gtk+ version 2.18
--
entryBufferLength :: EntryBufferClass self => ReadAttr self Word16
entryBufferLength = readAttrFromUInt16Property "length"
...
-- * Available since Gtk+ version 2.18
--
entryBufferMaxLength :: EntryBufferClass self => Attr self Word16
entryBufferMaxLength = newAttrFromUInt16Property "max-length"
